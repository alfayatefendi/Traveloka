...
import com.example.traveloka.databinding.ItemRowHotelBinding
import com.example.traveloka.model.Hotel

class HotelListAdapter (
    private val onClickItem: (hotel: Hotel) -> Unit
): ListAdapter<Hotel, HotelListAdapter.HotelListViewHolder>(DiffCallBack){

    private lateinit var ctx: Context

    inner class HotelListViewHolder(binding: ItemRowHotelBinding): RecyclerView.ViewHolder(binding.root){
