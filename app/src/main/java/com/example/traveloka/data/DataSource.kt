package com.example.traveloka.data
...
object DataSource {
    ...
    val listMenuFirst: kotlinx.coroutines.flow.Flow<List<Menu>> = flow {
    ...
    val listMenuSecond: kotlinx.coroutines.flow.Flow<List<Menu>> = flow {
        val data: MutableList<Menu> = mutableListOf()
    ...
    val listPromoLandscape: kotlinx.coroutines.flow.Flow<List<Int>> = flow {
    ...
    val listHotel: kotlinx.coroutines.flow.Flow<List<Hotel>> = flow {
    ...
    val listHotelByCities: (q: Cities) -> kotlinx.coroutines.flow.Flow<List<Hotel>> = { q ->
        flow {
            val data: MutableList<Hotel> = mutableListOf()
    ...
    val listPromo: kotlinx.coroutines.flow.Flow<List<Promo>> = flow {
